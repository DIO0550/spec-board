import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./iframe-Botl51Z-.js";import{a as r,i,n as a,r as o,t as s}from"./TaskCreateScreen-CGuhPuSt.js";import{t as c}from"./jsx-runtime-Bn1Ys6_W.js";import{n as l,t as u}from"./result-DYUyfXdh.js";import{t as d}from"./useTheme-D2bw4C5m.js";import{t as f}from"./shell-CJ3SjCFF.js";import{n as p,t as m}from"./task-DjrcEorc.js";import{f as h,n as g}from"./ProjectProvider-BHV6zOD2.js";import{i as _,n as v,r as y}from"./test-fixtures-BogoZePH.js";import{r as b,t as x}from"./label-definition-BpRSXVXS.js";import{n as S,t as C}from"./ToastProvider-bqsdmMOb.js";var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y;t((()=>{i(),w=e(n(),1),b(),f(),g(),S(),v(),p(),l(),a(),T=c(),{expect:E,fireEvent:D,fn:O,userEvent:k,within:A}=__STORYBOOK_MODULE_TEST__,j={parent:m.fromPayload({id:`p-stub`,title:`stub parent`,status:y[0]?.name??`Todo`,labels:[],links:[],children:[],reverseLinks:[],body:``,filePath:`tasks/stub-parent.md`}),failedSubIssues:[]},M=({children:e})=>((0,w.useState)(()=>{r(e=>{if(e===`preview_task_filename`)return{kind:`path`,fileName:`new-issue.md`,relPath:`tasks/new-issue.md`,fullPath:`/workspace/payments-service/tasks/new-issue.md`};if(e===`get_task_templates`)return{templates:[{name:`bug-report`,title:`バグ報告`,status:`Todo`,priority:`High`,labels:[`bug`],links:[],draft:!1,body:`## 再現手順
