...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            task::archive::command::archive_task,
            task::archive::command::get_archived_tasks,
            task::archive::command::unarchive_task,
            task::trash::command::get_trashed_tasks,
            task::trash::command::restore_trashed_task,
            task::trash::command::purge_trashed_task,
            task::trash::command::empty_trash,
