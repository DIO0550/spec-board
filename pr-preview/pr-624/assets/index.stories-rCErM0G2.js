import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./iframe-Bt93SX8Z.js";import{a as r,i,n as a,r as o,t as s}from"./TaskCreateScreen-CIjctTWQ.js";import{t as c}from"./jsx-runtime-Bn1Ys6_W.js";import{n as l,t as u}from"./result-7c-baUo1.js";import{t as d}from"./useTheme-BDdOffDm.js";import{t as f}from"./shell-CjiYB4Jm.js";import{n as p,t as m}from"./task-bSS-Oy1E.js";import{f as h,n as g}from"./ProjectProvider-CP9IbdER.js";import{i as _,n as v,r as y}from"./test-fixtures-Ck8nEBqB.js";import{n as b,t as x}from"./ToastProvider-OyDPOQi_.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K;t((()=>{i(),S=e(n(),1),f(),g(),b(),v(),p(),l(),a(),C=c(),{expect:w,fireEvent:T,fn:E,userEvent:D,within:O}=__STORYBOOK_MODULE_TEST__,k={parent:m.fromPayload({id:`p-stub`,title:`stub parent`,status:y[0]?.name??`Todo`,labels:[],links:[],children:[],reverseLinks:[],body:``,filePath:`tasks/stub-parent.md`}),failedSubIssues:[]},A=({children:e})=>((0,S.useState)(()=>{r(e=>{if(e===`preview_task_filename`)return{kind:`path`,fileName:`new-issue.md`,relPath:`tasks/new-issue.md`,fullPath:`/workspace/payments-service/tasks/new-issue.md`};if(e===`get_task_templates`)return{templates:[{name:`bug-report`,title:`バグ報告`,status:`Todo`,priority:`High`,labels:[`bug`],links:[],draft:!1,body:`## 再現手順
