import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-Bn1Ys6_W.js";import{j as n,t as r}from"./tauri-BJqdchci.js";import{n as i,t as a}from"./PreviewPane-_0lKMna6.js";var o,s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{r(),i(),o=t(),{fn:s,userEvent:c,within:l}=__STORYBOOK_MODULE_TEST__,u={component:a,args:{state:{kind:`ready`,markdown:`---
...
status: Todo
---
`,error:null}}},h={play:async({canvasElement:e})=>{await c.click(l(e).getByRole(`button`,{name:`Raw`}))}},g={args:{state:{kind:`pending`,markdown:null,error:null}}},_={name:`Error`,args:{state:{kind:`error`,markdown:null,error:new n(`PARSE_ERROR`,`プレビューを生成できません`)}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{}`,...d.parameters?.docs?.source}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{}`,...f.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    state: {
      kind: "ready",
      markdown: \`---\\ntitle: '\${"非常に長いタイトル".repeat(10)}'\\nstatus: Todo\\n---\\n\`,
