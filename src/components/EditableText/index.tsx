...
const DISPLAY_CLASS_NAME =
  "w-full cursor-pointer truncate rounded border-0 bg-transparent px-1 py-0.5 text-left text-lg font-semibold text-foreground hover:bg-surface-muted focus:outline-none focus-visible:bg-surface-muted focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1";
const EDIT_CLASS_NAME =
  "w-full rounded border border-accent px-1 py-0.5 text-lg font-semibold text-foreground outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1";
